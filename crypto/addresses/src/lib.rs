//!
//! Jio [`Address`] implementation.
//!
//! In it's string form, the Jio [`Address`] is represented by a `bech32`-encoded
...
/// Address prefix identifying the network type this address belongs to (such as `jio`, `jiotest`, `jiosim`, `jiopadev`).
#[derive(PartialEq, Eq, PartialOrd, Ord, Clone, Copy, Debug, Hash, Serialize, Deserialize, BorshSerialize, BorshDeserialize)]
#[borsh(use_discriminant = true)]
pub enum Prefix {
    #[serde(rename = "jio")]
    Mainnet,
    #[serde(rename = "jiotest")]
    Testnet,
    #[serde(rename = "jiosim")]
    Simnet,
    #[serde(rename = "jiopadev")]
    Devnet,
    #[cfg(test)]
    A,
    #[cfg(test)]
...
///
///  Jio `Address` version (`PubKey`, `PubKey ECDSA`, `ScriptHash`)
///
/// @category Address
#[derive(PartialEq, Eq, PartialOrd, Ord, Clone, Copy, Debug, Hash, Serialize, Deserialize, BorshSerialize, BorshDeserialize)]
#[repr(u8)]
...
/// Jio [`Address`] struct that serializes to and from an address format string: `jio:qz0s...t8cv`.
///
/// @category Address
...
mod tests {
    ...
    fn cases() -> Vec<(Address, &'static str)> {
        ...
        vec![
            ...
            (Address::new(Prefix::Testnet, Version::PubKey, &[0u8; 32]),      "jiotest:qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq0tvfsppx"),
            (Address::new(Prefix::Testnet, Version::PubKeyECDSA, &[0u8; 33]), "jiotest:qyqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzg70v3fs"),
            (Address::new(Prefix::Testnet, Version::PubKeyECDSA, b"\xba\x01\xfc\x5f\x4e\x9d\x98\x79\x59\x9c\x69\xa3\xda\xfd\xb8\x35\xa7\x25\x5e\x5f\x2e\x93\x4e\x93\x22\xec\xd3\xaf\x19\x0a\xb0\xf6\x0e"), "jiotest:qxaqrlzlf6wes72en3568khahq66wf27tuhfxn5nytkd8tcep2c0vrsvt3nfz4d"),
            (Address::new(Prefix::Mainnet, Version::PubKey, &[0u8; 32]),      "jio:qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqu3v2qv4j"),
            (Address::new(Prefix::Mainnet, Version::PubKey, b"\x5f\xff\x3c\x4d\xa1\x8f\x45\xad\xcd\xd4\x99\xe4\x46\x11\xe9\xff\xf1\x48\xba\x69\xdb\x3c\x4e\xa2\xdd\xd9\x55\xfc\x46\xa5\x95\x22"), "jio:qp0l70zd5x85ttwd6jv7g3s3a8llzj96d8dncn4zmhv4tlzx5k2jy2qhcgkfe"),
        ]
        // cspell:enable
    }
    ...
    fn test_errors() {
        ...
        let address_str: String = format!("jio:qqqqqqqqqqqqq{invalid_char}qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqkx9awp4e");
        let address: Result<Address, AddressError> = address_str.try_into();
    ...
    pub fn test_wasm_serde_constructor() {
        let str = "jio:qpauqsvk7yf9unexwmxsnmg547mhyga37csh0kj53q6xxgl24ydxjsgzthw5j";
    ...
    pub fn test_wasm_js_serde_object() {
        let expected = Address::constructor("jio:qpauqsvk7yf9unexwmxsnmg547mhyga37csh0kj53q6xxgl24ydxjsgzthw5j");
        ...
        obj.set("prefix", &JsValue::from_str("jio")).unwrap();
