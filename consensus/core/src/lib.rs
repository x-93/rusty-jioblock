...
// Re-export jio_hashes for use throughout the crate
// Re-export crypto_hashes types
pub use crypto_hashes::Hash;
pub const HASH_SIZE: usize = 32;
// Construct ZERO_HASH using a const constructor from the Hash type
